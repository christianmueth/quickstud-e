    ...
    return (
      <div className="space-y-3">
        <div>
          ...
          <h2 className="text-xl font-semibold">Pick up a recent learning space</h2>
        </div>
          ...
          <div className="flex gap-4 pr-2 snap-x">
            {decks.map((d) => (
              ...
              >
                ...
                <div className="text-xs text-gray-500 mt-1">{d._count.cards} prompt{d._count.cards === 1 ? "" : "s"}</div>
              </Link>
            ))}
          </div>
        </div>
